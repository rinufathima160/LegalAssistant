import { Scale, MessageSquare, Bell, Plus, BarChart3 } from 'lucide-react';
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
      ...
      <button
        ...
        className="bg-white/95 hover:bg-white p-8 rounded-2xl shadow-xl transition-all hover:scale-105 text-left group"
      >
        <div className="bg-purple-500 w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:bg-purple-600 transition-colors">
        ...
        <p className="text-gray-600">
          Analyze system accuracy using Precision, MRR and similarity metrics
        </p>
      </button>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-white">
          <div>
            ...
            <p className="text-blue-200 text-sm">
              Get answers to your legal questions anytime
            </p>
          </div>
          <div>
            <h4 className="font-semibold mb-2">Smart Reminders</h4>
            <p className="text-blue-200 text-sm">
              Never miss important legal deadlines
            </p>
          </div>
          <div>
